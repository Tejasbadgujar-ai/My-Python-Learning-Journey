...
#** init fuction is the constructor olready assined the constructor but this time contructor in class and object assined him **#
...
class Ganpati(): #assined the class name 
   ...
   def __init__(self,name,marks):  #init fuction using creating class and mentiones parameteres 1st everytime self paramenter after anothers 
      self.name =name #they can parameter assin tna name and after second paramenter assining
      self.marks=marks
